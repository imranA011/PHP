...
class Question extends Database{
    ...
    {   
        $query = "SELECT questions.id, questions.title, questions.user_id AS q_user_id, COUNT(answers.question_id) AS answer_count FROM questions LEFT JOIN answers ON questions.id=answers.question_id GROUP BY questions.id";
