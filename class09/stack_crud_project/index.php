...
<?php include_once 'navbar.php';?>
        ...
        <!-- Masthead-->
        <header class= "bg-primary text-white text-center py-5 vh-50">
            <div class="container d-flex align-items-center flex-column">
               <!-- Masthead Heading-->
                <h1 class="text-uppercase py-5 my-5">Make Question - Get Answer</h1>
        ...
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Newest Questions</h2>
                <!-- Icon Divider-->
